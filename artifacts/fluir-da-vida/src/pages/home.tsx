  ...
  return (
    <main className="foundation-page">
      <div className="foundation-inner">
        <header
          className="foundation-header reveal"
          data-testid="header-foundation"
        >
        ...
        <section className="foundation-hero">
          <div className="reveal reveal-delay-1">
            ...
            <h1 className="hero-title">
              Um lugar para
              <br />o cuidado <em>fluir.</em>
            </h1>
            <p className="hero-copy">
              A fundação técnica do <strong>Projeto Fluir</strong> está pronta.
              Estamos construindo, com calma e precisão, a base que vai
              sustentar os próximos capítulos do produto.
            </p>
            <div className="hero-caption">começamos pelo essencial</div>
          </div>
          <div
            className="architecture-card reveal reveal-delay-2"
          ...
          >
            ...
            <div
              ...
              aria-label="Diagrama abstrato da fundação do projeto"
            >
        ...
        <section
          className="foundation-strip reveal reveal-delay-2"
          aria-label="Status da fundação"
        >
          ...
          <div className="strip-item">
            ...
            <div className="strip-value">
              <span className="ok">Operacional</span>
            </div>
          </div>
          <div className="strip-item">
        ...
        <section className="modules-section">
          <div className="section-heading reveal reveal-delay-2">
            ...
            <p className="section-intro">
              Os módulos do produto serão apresentados aqui quando estiverem
              prontos para receber você.
            </p>
          </div>
          <div
            className="module-list reveal reveal-delay-3"
            data-testid="list-modules"
          >
            {[
              [
                "01",
                "Experiências de cuidado",
                "Uma base simples para acompanhar cada jornada.",
                "em breve",
              ],
              [
                "02",
                "Conexões que importam",
                "Espaços pensados para aproximar pessoas e presença.",
                "em breve",
              ],
              [
                "03",
                "Ritmos do dia a dia",
                "Ferramentas que respeitam o tempo de cada história.",
                "em breve",
              ],
        ...
        <section className="ready-section">
          <div className="reveal reveal-delay-2">
            <h2 className="ready-title">
              A primeira parte já está <span>viva.</span>
            </h2>
            <p className="ready-copy">
              A estrutura está preparada para crescer de forma intencional. Por
              enquanto, este é um ponto de partida — e não uma tela de produto.
            </p>
          </div>
